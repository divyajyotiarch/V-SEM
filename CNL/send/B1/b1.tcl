...
#$ns duplex-link $n1 $n1 2Mb 10ms DropTail             for packet dropping
$ns duplex-link $n1 $n2 1.7Mb 20ms DropTail             #for no packet dropping
...
#$ns duplex-link-op $n1 $n1 orient right-up
